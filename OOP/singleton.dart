...
class FileSystemManager {
  ...
  // Factory constructor to control the creation of the singleton
  ...
  // Method to simulate writting to a file
  void writeFile(String fileName, String content) {
    print("Writting to file: $fileName with content: '$content'");
  }
}
...
void main() {
  ...
  // Verify that both refernces point to the same singleton instance
  ...
  // Callingg methods on both references
